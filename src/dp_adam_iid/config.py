"""Configuration loading and validation for the QNLI experiment."""
...
class PrivacyConfig:
    ...
    # Opacus recommends non-wrapping hooks for Hugging Face Transformers.
...
class Config:
    ...
    def validate(self) -> None:
        """Reject configuration choices outside this deliberately narrow experiment."""
...
def load_config(path: str | Path) -> Config:
    """Load one complete YAML experiment configuration."""
